    ...
    <div class="page-content browse container-fluid">   
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                ?>
                <form class="form-inline" action="{{url('admin/report-customer-care')}}" method="POST">
                    <input type="hidden" id="_token" name="_token" value="{{ csrf_token() }}"/>
                     <div class="col-sm-12 text-left">
                            ...
                            <div class="form-group">
                                <label for="colFormLabelLg" style="font-weight: bold;">Chọn TK CS:</label>
                            </div>
                            <select class="form-control" id="customercare_search" name="customercare">
                    ...
                    <table id="dataTable" class="table table-hover">
                        ...
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td colspan="" rowspan="" headers="" style="color: #22a7f0;"><span style="font-weight: bold;">{{$val->cs_name_history}}</span></td>
                                ...
                                <form action="{{url('admin/report-customer-care-save')}}" method="post" accept-charset="utf-8">
                                    @csrf
                                    <td>
                                        <input type="hidden" name="user_id" value="{{$val->id_cs}}">
                                        <input type="hidden" name="role_id" value="{{$val->role_id}}">
...
@section('javascript')
    <script type="text/javascript">
        ...
        $('#customercare_search option[value={{$customercare_input}}]').attr('selected','selected');
    </script>
@stop
