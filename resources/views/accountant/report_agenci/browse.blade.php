    ...
    <div class="page-content browse container-fluid">   
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                ?>
                <form class="form-inline" action="{{url('admin/report-agencies')}}" method="POST">
                    <input type="hidden" id="_token" name="_token" value="{{ csrf_token() }}"/>
                     <div class="col-sm-12 text-left">
                        ...
                        <div class="form-group ">
                            <label for="colFormLabelLg" style="font-weight: bold;">Chọn TK Agencies:</label>
                        </div>
                        <select class="form-control" id="agencies_search" name="agencies">
                    ...
                    <table id="dataTable" class="table table-hover">
                        ...
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td colspan="" rowspan="" headers="" style="color: #22a7f0;"><span style="font-weight: bold;">{{$val->agencies}}</span></td>
                                ...
                                <form action="{{url('admin/report-agencies-save')}}" method="post" accept-charset="utf-8">
                                    @csrf
                                    <td>
                                        <input type="hidden" name="user_id" value="{{$val->user_ref_id}}">
...
@section('javascript')
    <script type="text/javascript">
        ...
        $('#agencies_search option[value={{$agencies_input}}]').attr('selected','selected');
    </script>
@stop
