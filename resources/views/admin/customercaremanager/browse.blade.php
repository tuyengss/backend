            ...
            <div class="col-sm-12 text-center" style="background-color: white; padding-bottom: 20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-left">
                        ...
                        <h3 style="font-weight: bold;">Quản lý tài khoản QL-CSKH</h3>

                    </div>

                </div>

                <form class="form-inline" action="{{url('admin/customer-care-manager')}}" method="POST">
                    ...
                    <div class="container text-left" >
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="customer_care_manager" value="" placeholder="Nhập từ khóa tìm kiếm...">
                        </div>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    ...
                    <table id="dataTable" class="table table-hover">
                        ...
                        <tbody>
                           <?php $i = 1; ?>
                            @if($user_customercaremanager->count() > 0)
                            @foreach($user_customercaremanager as $key => $val)
                            <tr>
                                <td>{{$i++}}</td>
                                <td>{{$val->name}}</td>
                                <td>{{$val->email}}</td>
