            ...
            <div class="col-sm-12 text-center" style="background-color: white; padding-bottom: 20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-left">
                        ...
                        <h3 style="font-weight: bold;">Quản lý tài khoản TCTD: </h3>

                    </div>

                </div>

                <form class="form-inline" action="{{url('admin/partner')}}" method="POST">
                    ...
                    <div class="container text-left" >
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="name_tctd" value="" placeholder="Nhập từ khóa tìm kiếm...">
                        </div>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    ...
                    <table id="dataTable" class="table table-hover">
                        ...
                        <tbody>
                            <?php $i = 1; ?>
                            @if($user_tctd->count() > 0)
                            @foreach($user_tctd as $key => $val)
                            <tr>
                                <td>{{$i++}}</td>
                                <td>{{$val->name}}</td>
                                <td>{{$val->email}}</td>
